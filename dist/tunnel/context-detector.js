...
(function (ExecutionContext) {
    ExecutionContext["N8N"] = "n8n";
    ExecutionContext["OPAL"] = "opal";
    ExecutionContext["DOCKER"] = "docker";
    ExecutionContext["KUBERNETES"] = "kubernetes";
...
export function detectContext() {
    ...
    // Check for Opal
    else if (process.env.OPAL_WEBHOOK_URL ||
 ...
 */
export function getRecommendedTunnelConfig(detectionResult) {

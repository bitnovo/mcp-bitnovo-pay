...
export class WebhookHandler {
    ...
    async handle(request) {
        ...
        try {
            ...
            if (this.config.deviceSecret) {
                const validationResult = validateWebhookSignature(this.config.deviceSecret, nonce, request.rawBody, signature);
            ...
            try {
                ...
                logger.error('Webhook payload validation failed', error, {
     ...
     */
    generateEventId(identifier, nonce) {

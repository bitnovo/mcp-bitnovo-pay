 ...
 */
export const getTunnelStatusTool = {
...
export class GetTunnelStatusHandler {
    ...
    async handle(_args) {
        ...
        try {
            ...
            const duration = Date.now() - startTime;
            logger.error('get_tunnel_status failed', error instanceof Error ? error : new Error(String(error)), {
                duration,
 ...
 */
export function getTunnelStatusHandler(webhookServer) {

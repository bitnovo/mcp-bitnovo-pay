...
export class RequestLogger {
     ...
     */
    static logToolRequestStart(toolName, args) {
     ...
     */
    static logToolRequestComplete(context, success, error) {
        ...
        if (success) {
            ...
            logger.error('MCP tool request failed', error, {
                requestId: context.requestId,
                toolName: context.toolName,
     ...
     */
    static logApiRequestStart(method, url, operation) {
        const requestId = this.generateRequestId();
        const startTime = Date.now();
     ...
     */
    static logApiRequestComplete(context, statusCode, responseSize, error) {
        const duration = Date.now() - context.startTime;
